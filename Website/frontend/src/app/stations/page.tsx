...
const StationsPage = () => {
  ...
  useEffect(() => {
    if (!mapContainerRef.current || !role) return;
  ...
  const handleDelete = async () => {
    if (role !== "admin" || !stationData.id) return;
            ...
            <div className="flex flex-col flex-grow gap-4">
              ...
              <div className="flex items-center gap-3 mb-4">
                <button
                  ...
                  className="flex items-center justify-center rounded-full border-2 border-[#073051] text-[#073051] hover:bg-[#073051] hover:text-white w-[50px] h-[50px] duration-300"
                >
                  ...
                  >
                    {["JEEPNEY", "TRICYCLE", "VAN"].map((type) => (
                      <ToggleGroupItem
                        key={type}
                        value={type}
                        className="flex-1 flex justify-center items-center h-full border border-[#D1D1D1] rounded-none first:rounded-l-[15px] last:rounded-r-[15px] data-[state=on]:bg-[#1E86DA] data-[state=on]:border-[#1E86DA] data-[state=on]:text-white cursor-pointer transition-colors duration-200"
                      >
                ...
                {role === "admin" ? (
                  ...
                  <div className="mt-2 border rounded-lg overflow-hidden">
                    <table className="w-full text-center border-collapse">
                      ...
                      <tbody>
                        {stationData.destinations.map((d) => (
                          <tr key={d.id} className="border-t text-center">
