...
const Header: React.FC = () => {
  ...
  return (
    <header className="w-full flex items-center justify-between px-16 py-5 bg-white border-b border-[#D1D1D1] md:px-32 md:py-2 sm:px-6 sm:py-3">
      <div
        ...
        <DropdownMenu>
          ...
          >
            ...
            <DropdownMenuItem
              ...
              onSelect={() => {
                // localStorage.removeItem('authToken'); // For future logout handling
                router.push('/');
              }}
            >
              Logout
